...
const LevelWork = () => {
  ...
  return (
    <div className=" container flex flex-col items-center justify-center content-center w-1/2  p-5   ">
      ...
      <h1 className="p-2 bg-gray-950 rounded-md w-1/2 text-white font-bold mb-2 mt-32">
        المستوي التعليمي
      </h1>
      ...
      <div className="w-1/2 h-80 overflow-y-auto">
        {data ? (
          data?.map((x, i) => (
            <div
              key={i}
              className="p-1 flex flex-row justify-between w-full rounded-md bg-black text-white mt-2">
              <span>{x.title}</span>
              <button
