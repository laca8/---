            ...
            <div ref={contentRef}>
              <div className="flex flex-row justify-between mt-2 p-2 bg-gray-400 rounded-sm font-bold text-xl">
                ...
                {report?.data?.imp ? (
                  <p>
                    تم تنفيذ البلاغ{" "}
                    <span className="  m-auto text-xl bg-green-800 text-white  text-center ">
                      ✔
                    </span>
                  </p>
                ) : null}
              ...
              <div className="grid grid-cols-2 gap-2 max-md:grid-cols-1">
                <div className="border-2 border-gray-800 mt-2">
                  <p className="bg-gray-800 p-1 text-center">
                    بيانات متلقي البلاغ{" "}
                  </p>
                  ...
                  <div className="grid grid-cols-1 justify-evenly  max-sm:grid-cols-1  text-right p-1 w-full">
                    <div className="flex flex-col w-full p-1">
                      ...
                      <input
                        disabled
                        value={nameUser}
                        className="bg-gray-800 p-1 w-full rounded-sm border-2 border-gray-800"
                        type="text"
                        placeholder="ادخل اسم متلقي البلاغ"
                      />
                    </div>
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled
                        value={communicationReport}
                        className="bg-gray-800 p-1 w-full rounded-sm border-2 border-gray-800"
                        type="text"
                        placeholder="ادخل وسيلة البلاغ"
                      />
                    </div>
                  </div>
                </div>
                <div className="border-2 border-gray-800 mt-2 ">
                  <p className="bg-gray-800 p-1"> بيانات المتصل</p>
                  ...
                  <div className="grid grid-cols-3 justify-evenly  max-sm:grid-cols-1 text-right p-3">
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        ...
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                        type="number"
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={connCity}
                        onChange={(e) => setConnCity(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                        type="text"
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={connPlace}
                        onChange={(e) => setConnPlace(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                        type="text"
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={connShiek}
                        onChange={(e) => setConnShiek(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                        type="text"
                      />
                    </div>
                    <div className="flex flex-col w-auto p-1 ">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={connJop}
                        onChange={(e) => setConnJop(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                        type="text"
                    ...
                    <div className="flex flex-col w-auto p-1 ">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={connRelation}
                        onChange={(e) => setConnRelation(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                        type="text"
                        placeholder="ادخل درجة القرابة"
                      />
                    </div>
                    <div className="flex flex-col w-auto p-1 ">
              ...
              <div className="grid grid-cols-2 gap-2 max-md:grid-cols-1">
                <div className="border-2 border-gray-800  mt-2">
                  <p className="bg-gray-800 p-1 text-center">بيانات الحالة</p>
                  ...
                  <div className="grid grid-cols-3 max-sm:grid-cols-1 justify-evenly  text-right p-3 ">
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        ...
                        id="countries"
                        className="bg-gray-800 p-1 rounded-sm w-full border-2 border-gray-800"
                      />
                    </div>
                    <div className="flex flex-col w-auto  p-1">
                  ...
                  <div className="grid grid-cols-3 max-sm:grid-cols-1 justify-evenly  text-right p-3  ">
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={outWork}
                        onChange={(e) => setOutWork(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                      />
                    </div>
                    ...
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={marridStatus}
                        onChange={(e) => setMarridStatus(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                      />
                    </div>
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={healthInsure}
                        onChange={(e) => setHealthInsure(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                      />
                    </div>
                    <div className="flex flex-col  w-auto p-1">
                      ...
                      <input
                        disabled={report?.data?.imp}
                        value={finSupport}
                        onChange={(e) => setFinSupport(e.target.value)}
                        className="bg-gray-800 p-1 rounded-sm border-2 border-gray-800"
                      />
                    </div>
                  </div>
