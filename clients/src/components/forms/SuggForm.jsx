  ...
  return (
    <div className="mt-10 font-bold">
      ...
      <div className="border-2 border-gray-400">
        <p className="bg-gray-800 p-1 text-center"> بيانات الاستعلام </p>

        <div className="grid grid-cols-2 justify-evenly  max-sm:grid-cols-1  text-right p-1 w-full">
          <div className="flex flex-col w-full p-2">
            <label>
              النوع<span className="text-red-700">*</span>
            </label>
            <select
              value={"استعلام/استفسار"}
          ...
          <div className="flex flex-col w-auto p-2">
            <label>
              جهة الاستفسار<span className="text-red-700">*</span>
            </label>
            <select
              id="countries"
              value={suggSide}
              onChange={(e) => setSuggSide(e.target.value)}
              className="bg-gray-800 p-1 rounded-sm border-2 border-gray-400">
              <option value="" selected disabled hidden>
                اختر
              </option>

              <option>استفسار إعاقة حركية</option>
              <option>استفسار إعاقة سمعية</option>
              <option>استفسار إعاقة بصرية</option>
              <option>استفسار إعاقة ذهنية</option>
              <option>استفسار إعاقة متعددة</option>
            </select>
          </div>
        </div>
