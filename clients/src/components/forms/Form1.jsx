  ...
  return (
    <div className=" mt-20 font-bold">
      <p className="font-bold text-right text-red-700 mb-1">
        ملاحظة (1) الاسئلة ذات النجمة الحمراء ملؤها{" "}
      ...
      <div className="border-2 border-gray-400 p-5">
        <p className="bg-cyan-700 w-1/4 m-auto text-center p-2">
          بيانات متلقي البلاغ{" "}
        </p>
        ...
        <div className="grid grid-cols-3 justify-evenly  max-sm:grid-cols-1  text-right p-1 w-full">
          <div className="flex flex-col w-full p-1">
            <label>
              متلقي البلاغ <span className="text-red-700">*</span>
            </label>
            <input
              disabled
          ...
          <div className="flex flex-col  w-auto p-1">
            <label>
              وسيلة البلاغ <span className="text-red-700">*</span>
            </label>
            <select
              id="countries"
              className="bg-gray-800 p-1 rounded-sm w-full border-2 border-gray-400"
              value={communicationReport}
              onChange={(e) => setCommunicationReport(e.target.value)}>
      ...
      <div className="border-2 border-gray-400 mt-2">
        ...
        <div className="grid grid-cols-4 justify-evenly  max-sm:grid-cols-1 text-right p-3">
          ...
          <div className="flex flex-col  w-auto p-1">
            <label>
              رقم التليفون <span className="text-red-700">*</span>
            </label>
            <input
              maxLength={"11"}
          ...
          <div className="flex flex-col w-auto p-1 ">
            ...
            <input
              className="bg-gray-800 p-1 rounded-sm border-2 border-gray-400"
              value={connAge}
              onChange={(e) => setConnAge(e.target.value)}
              type="date"
